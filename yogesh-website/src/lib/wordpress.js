...
export function mapWPSiteSettings(item) {
  return {
    ...
    phone: item.phone || '+91 83779 56442',
    phoneUs: item.phone_us || '',
    phoneUk: item.phone_uk || '',
    phoneAu: item.phone_au || '',
    email: item.email || 'hello@yogeshwebdeveloper.com',
    location: item.location || 'Delhi, India',
    whatsappUrl: item.whatsapp_url || 'https://wa.me/918377956442',
    whatsappMessage: item.whatsapp_message || 'Hi Yogesh, I found your website and would like to discuss a project.',
    chatWelcome: item.chat_welcome || "Hi! I'm Yogesh's assistant 👋 Ask about services, pricing, or hiring!",
