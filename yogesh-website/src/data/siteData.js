...
export const engagementModels = [
  {
    title: 'Hourly Basis',
    description: 'Flexible hourly engagement for small tasks, fixes and quick consultations.',
    icon: 'clock',
  },
  {
    title: 'Part Time',
    description: 'Dedicated part-time developer for ongoing projects with regular weekly hours.',
    icon: 'user',
    popular: true,
  },
  {
    title: 'Full Time',
    description: 'Full-time dedicated developer embedded in your team for large-scale projects.',
    icon: 'briefcase',
  },
]
...
export const footerHireLocations = [
  'Hire Me in USA',
  'Hire Me in Canada',
  'Hire Me in Australia',
  'Hire Me in UK',
  'Hire Me in Europe',
  'Hire Me in Delhi',
]
